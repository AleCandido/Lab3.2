...
% queste lunghezze d'onda andrebbero confrontate con qualcosa, inoltre il punto corrispondente per la lunghezza d'onda della riga osservata del sodio andrebbe evidenziato nel grafico del fit( tanto per avere un idea di dove starebbe secondo me);
...
$Ry= 0.01098 \pm 0.0007 nm^{-1}$ BISOGNA FARE TORNARE QUESTO ERRORE...\\ 
$\chi^2=6.1$ (d.o.f.=3)\\

Questo è da confrontare con il valore teorico di $0.010973 nm^{-1}$ (o meglio $0.010968 nm^{-1}$, correzione dovuta alla massa ridotta dell'idrogeno)
...
\end{itemize}
Si ritiene la prima ipotesi molto più probabile, considerando anche la relativa poca brillantezza della lampada ad idrogeno. In particolare si è visto:
\begin{table}[H]
	\centering
	\begin{tabular}{c|c|c|c|c|c}
		colore & $\alpha_i$ &	$\theta_i$ & ordine & lunghezza d'onda [nm] & sodio  \\
		\hline
d-viola &  $ 83\degree 7.0' \pm 2.0 ' $  &  $ 29\degree 54.0' \pm 2.0 ' $  &  $ 1 $ & $ 352.4+/-0.5 $ & $ 467\pm 7 $ \\
rosso &  $ 102\degree 29.0' \pm 2.0 ' $  &  $ 10\degree 32.0' \pm 2.0 ' $  &  $ 1 $ & $ 616.1+/-0.6 $ & $ 520 \pm 9 $ \\
Dunque si ritiene molto probabile che le linee viste provengano dalla contaminazione provocata dalla luce della lampada al sodio. Non si capisce perché non siano state viste anche le ben più brillanti linee gialle del sodio (forse non essendo prevista non è stata semplicemente notata).
\end{tabular}
	\caption{Misura delle righe spettrali dell'idrogeno, la d nel nome significa che in realtà la linea è un doppietto, di cui un componente è talmente fioco da non poter essere misurato. }
	\label{tab:HH}
\end{table}
