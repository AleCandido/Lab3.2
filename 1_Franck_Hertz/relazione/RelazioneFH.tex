...
Questo ha permesso l'individuazione (temporale) dei massimi con una precisione maggiore del singolo campionamento. L'errore fornito dal programma, stimato grazie al fit delle parabole, è sicuramente sottostimato. Non si è infatti svolto alcun tipo di test del $\chi^2$ su tali parabole in quanto...
