...
Inoltre si è trascurato l'errore dovuto alla misura dei valori di tensione con cui erano identificati i vari punti($50\%$ dei valori picco-picco, overshoot esclusi), assumendo pendenza nulla su di essi e quindi trascurandoli nella propagazione.
