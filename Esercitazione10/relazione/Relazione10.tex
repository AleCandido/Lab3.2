...
\'E dunque stata presa la tensione di ingresso (con il multimetro digitale) e la tensione di uscita (con l'oscilloscopio) per diversi valori della resistenza $R_1$. I dati raccolti sono riassunti in Figura \ref{fig:VinVout}.
...
Gli stessi dati sono stati presi sostituendo il partitore di ingresso con l'uscita del generatore di frequenza settato per generare una rampa triangolare.
