...
Tutti i dati presentati sono confrontati con i valori tipici presenti nel datasheet nella tabella \ref{Vresults}.
 ...
 \begin{table}[H]
	...
	\begin{tabular}{c|c|c|c|c}
		...
		\hline
	\end{tabular}
	\caption{Tutti i valori risultano compatibili con quanto presente nel datasheet. Da notare che comuque le caratteristiche di uscita misurate dal datasheet sono con corrente di uscita non nulla, dunque con condizioni peggiori rispetto a quelle da noi sperimentate.}
	\label{Vresults}
\end{table}
