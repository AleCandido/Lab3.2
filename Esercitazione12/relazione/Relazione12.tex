...
\emph{MANCANTE Qual e’ la funzione della porta NOT sull’ingresso? L’ingresso EN è attivo alto
oppure attivo basso ?}
...
% non è c'è solo quello come errore da considerare, ma ci mettiamo anche quello sistematico ecc. In totale io metterei (per coerenza con quanto sta scritto nelle altre parti, un errore di 2ns).
