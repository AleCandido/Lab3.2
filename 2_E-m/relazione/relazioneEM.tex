...
Dopo aver preso i valori dei raggi e  verificato l'andamento del campo magnetico, utilizzando sempre le formule \eqref{eq:em} e \eqref{eq:vacc} si è effettuato un fit lineare di $(Br)^{2} vs V_{Acc}$, in cui il coefficiente angolare è  
