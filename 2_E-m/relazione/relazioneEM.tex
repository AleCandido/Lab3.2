...
Si è inoltre controllato come vari il campo magnetico in funzione della distanza dall'asse del sistema. Ci si aspetta una curva teorica di questo tipo \ref{TEO}
...
Si è dunque confrontata la suddetta curva teorica con i valori presi spazzando con la sonda lungo un raggio. Per ulteriori dettagli si rimandi alla sezione "Variazione $B_z(r)$/$B_z^{MAX}$".
