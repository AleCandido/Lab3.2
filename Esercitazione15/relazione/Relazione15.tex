...
e i parametri trovati dal fit sono:\marginpar{NUMERI DA AGGIORNARE}
\[ A_2^\star=(1.504 \pm 0.013)\cdot10^5 \qquad Q=7.54 \pm 0.12 \qquad f_0=6.089 \pm 0.006~\kilo\hertz  \]

da cui si può dedurre il valore dell'amplificazione di centro banda $ A_{2,0} $ e la larghezza di banda $ \Delta f $:\marginpar{NUMERI DA AGGIORNARE}
...
\label{resnull}
\end{equation}
che rappresenta il rumore in uscita a resistenza nulla.\marginpar{NUMERI DA AGGIORNARE} Il Guadagno $A$ è quello complessivo di tutto il circuito, cioè $A = A_0 A_1 A_2 A_3 = (1.17\pm0.02)e+05 $.
\vspace*{-10pt}
\begin{equation}
...
\marginpar{NUMERI DA AGGIORNARE}
...
I valori ottenuti per l'amplificazione totale e per la banda passante sono rispettivamente:\marginpar{NUMERI DA AGGIORNARE}
...
A questo punto, utilizzando la \eqref{resnull} e la \eqref{kb} si è ricavata la costante di Boltzmann con entrambi i metodi sopra descritti.\marginpar{NUMERI DA AGGIORNARE} Si sono ottenuti come risultati rispettivamente $k_b = (1.18\pm0.16)e-23~J/K$ e $k_{b,1000:1} = (1.56\pm0.21)e-23~J/K $. Il valore atteso per la costante di Boltzmann è $k_b = 1.380e-23~J/K$.
\newline
